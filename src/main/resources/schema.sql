...
CREATE TABLE IF NOT EXISTS PUBLIC.GENRES_FILMS (
	...
	CONSTRAINT GENRES_FILMS_FK FOREIGN KEY (FILM_ID) REFERENCES PUBLIC.FILMS(ID) ON DELETE RESTRICT ON UPDATE RESTRICT,
...
CREATE TABLE IF NOT EXISTS PUBLIC.FILMS_LIKES (
	...
	CONSTRAINT FILMS_LIKES_FK FOREIGN KEY (USER_ID) REFERENCES PUBLIC.USERS(ID),
	CONSTRAINT FILMS_LIKES_FK_1 FOREIGN KEY (FILM_ID) REFERENCES PUBLIC.FILMS(ID)
);
